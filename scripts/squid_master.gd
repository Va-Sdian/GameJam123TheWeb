...
@export var MAX_SPEED = 300 #110 Скорость игрока
...
@onready var player_health_restore = 15
@onready var base_health_restore = 25
...
func _color_change():
	...
	var _one_precent_of_programmed_distance = 4
	...
	modulate = Color(135/255.0, 1, 92/255.0, color_change)
