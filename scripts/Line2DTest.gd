...
func NetJointLine(node_a, node_b):
	jointLine.points = []
	#jointLine.add_point(Vector2.ZERO) #Рисует позицию, но неправильно
	...
	jointLine.add_point(node_b.global_position - self.global_position)
